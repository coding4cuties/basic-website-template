# Basic Website Template (Bat Version)🦇
...
2. Run `npm run dev` to start the server on your `localhost:3000`
3. Enjoy!
...
Bat image and fun facts from [Batcon.org](https://www.batcon.org/)
